function CarouselHome (){
    ...
    const textCarousel = [
      ...
      ['We Transform', '', '#learn-more', 'Learn More'],
    ];
    ...
    for (let i = 0; i < 2; i++) {
      ...
      if (i == 0) {buttonElement.setAttribute('target', '_blank');}
...
function BPHMember() {
    ...
    for (let i = 0; i < members.length; i++) {
        text += '<div class="item features-image col-12 col-md-6 col-lg-3"> \
                    <div class="item-wrapper"> \
                        <div class="item-img mb-3"> \
                            <img src="' + members[i].img + '"> \
                        </div> \
                        <div class="item-content align-left"> \
                            <h6 class="item-subtitle mbr-fonts-style"> \
                                <strong>' + members[i].name + '</strong> \
                            </h6> \
                            <p class="mbr-text mbr-fonts-style">' + members[i].role + '</p> \
                        </div> \
                    </div> \
                </div>';
    }
